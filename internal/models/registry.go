...
var defaultModels = []Model{
	...
	{Alias: "claude-opus-5-5", BedrockID: "anthropic.claude-opus-5-5", OwnedBy: "anthropic", CrossRegion: true, NoSampling: true, Reasoning: true},
	...
	// reason within the output-token budget.
